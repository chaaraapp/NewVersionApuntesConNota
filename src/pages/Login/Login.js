...
const LoginForm = () => {
    ...
    return (
        <div className="pt-[7rem] pb-[3rem] flex justify-center items-center bg-[var(--primary)]">
            ...
            <div onSubmit={handelSubmit} className="form-container w-[30rem] m-auto p-[8px] border border-[#ccc] bg-[#f5f5f5] rounded-[8px]" style={{ boxShadow: "0 4px 8px rgba(0, 0, 0, 0.2)" }}>
                ...
                <form className="border-b-[4px] border-b-[#ccc]">
                    ...
                    <div className="input-container">
                        ...
                        <input type="email" id="email" name="email"
                            className="w-full p-[10px] mb-[8px] rounded-[4px]" value={formData.email}
                            onChange={e => setFormData(perv => ({ ...perv, email: e.target.value }))}
                            placeholder={!formErrors?.email ? "Correo electrónico" : formErrors.email}
                            style={!formErrors?.email ? { border: '1px solid #ccc' } : { border: '1px solid red' }} />
                    ...
                    <div className="input-container">
                        <input type="password" id="password" name="password"
                            className="w-full p-[10px] mb-[8px] rounded-[4px]"
                            value={formData.password}
                            onChange={e => setFormData(perv => ({ ...perv, password: e.target.value }))}
                            placeholder={!formErrors?.password ? "Contraseña" : formErrors.password}
                            style={!formErrors?.password ? { border: '1px solid #ccc' } : { border: '1px solid red' }} />
